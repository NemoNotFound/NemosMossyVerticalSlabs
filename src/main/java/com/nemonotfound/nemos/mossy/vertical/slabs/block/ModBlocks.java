...
public class ModBlocks {
    ...
    public static final Block CRIMSON_MOSSY_OAK_VERTICAL_SLAB = register("crimson_mossy_oak_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(OAK_SLAB));
    public static final Block CRIMSON_MOSSY_SPRUCE_VERTICAL_SLAB = register("crimson_mossy_spruce_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(SPRUCE_SLAB));
    public static final Block CRIMSON_MOSSY_BIRCH_VERTICAL_SLAB = register("crimson_mossy_birch_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(BIRCH_SLAB));
    public static final Block CRIMSON_MOSSY_JUNGLE_VERTICAL_SLAB = register("crimson_mossy_jungle_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(JUNGLE_SLAB));
    public static final Block CRIMSON_MOSSY_ACACIA_VERTICAL_SLAB = register("crimson_mossy_acacia_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(ACACIA_SLAB));
    public static final Block CRIMSON_MOSSY_DARK_OAK_VERTICAL_SLAB = register("crimson_mossy_dark_oak_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(DARK_OAK_SLAB));
    public static final Block CRIMSON_MOSSY_MANGROVE_VERTICAL_SLAB = register("crimson_mossy_mangrove_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(MANGROVE_SLAB));
    public static final Block CRIMSON_MOSSY_CHERRY_VERTICAL_SLAB = register("crimson_mossy_cherry_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(CHERRY_SLAB));
    public static final Block CRIMSON_MOSSY_PALE_OAK_VERTICAL_SLAB = register("crimson_mossy_pale_oak_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(PALE_OAK_SLAB));
    public static final Block CRIMSON_MOSSY_BAMBOO_VERTICAL_SLAB = register("crimson_mossy_bamboo_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(BAMBOO_SLAB));
    public static final Block CRIMSON_MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB = register("crimson_mossy_bamboo_mosaic_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(BAMBOO_MOSAIC_SLAB));
    public static final Block CRIMSON_MOSSY_CRIMSON_VERTICAL_SLAB = register("crimson_mossy_crimson_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(CRIMSON_SLAB));
    public static final Block CRIMSON_MOSSY_WARPED_VERTICAL_SLAB = register("crimson_mossy_warped_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(WARPED_SLAB));
    public static final Block CRIMSON_MOSSY_STONE_VERTICAL_SLAB = register("crimson_mossy_stone_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(STONE_SLAB));
    public static final Block CRIMSON_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB = register("crimson_mossy_cobbled_deepslate_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(COBBLED_DEEPSLATE_SLAB));
    public static final Block CRIMSON_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB = register("crimson_mossy_deepslate_brick_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(DEEPSLATE_BRICK_SLAB));
    public static final Block CRIMSON_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB = register("crimson_mossy_deepslate_tile_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(DEEPSLATE_TILE_SLAB));
    public static final Block CRIMSON_MOSSY_TUFF_VERTICAL_SLAB = register("crimson_mossy_tuff_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(TUFF_SLAB));
    public static final Block CRIMSON_MOSSY_TUFF_BRICK_VERTICAL_SLAB = register("crimson_mossy_tuff_brick_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(TUFF_BRICK_SLAB));
    public static final Block CRIMSON_MOSSY_BRICK_VERTICAL_SLAB = register("crimson_mossy_brick_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(BRICK_SLAB));
    public static final Block WARPED_MOSSY_OAK_VERTICAL_SLAB = register("warped_mossy_oak_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(OAK_SLAB));
    public static final Block WARPED_MOSSY_SPRUCE_VERTICAL_SLAB = register("warped_mossy_spruce_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(SPRUCE_SLAB));
    public static final Block WARPED_MOSSY_BIRCH_VERTICAL_SLAB = register("warped_mossy_birch_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(BIRCH_SLAB));
    public static final Block WARPED_MOSSY_JUNGLE_VERTICAL_SLAB = register("warped_mossy_jungle_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(JUNGLE_SLAB));
    public static final Block WARPED_MOSSY_ACACIA_VERTICAL_SLAB = register("warped_mossy_acacia_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(ACACIA_SLAB));
    public static final Block WARPED_MOSSY_DARK_OAK_VERTICAL_SLAB = register("warped_mossy_dark_oak_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(DARK_OAK_SLAB));
    public static final Block WARPED_MOSSY_MANGROVE_VERTICAL_SLAB = register("warped_mossy_mangrove_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(MANGROVE_SLAB));
    public static final Block WARPED_MOSSY_CHERRY_VERTICAL_SLAB = register("warped_mossy_cherry_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(CHERRY_SLAB));
    public static final Block WARPED_MOSSY_PALE_OAK_VERTICAL_SLAB = register("warped_mossy_pale_oak_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(PALE_OAK_SLAB));
    public static final Block WARPED_MOSSY_BAMBOO_VERTICAL_SLAB = register("warped_mossy_bamboo_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(BAMBOO_SLAB));
    public static final Block WARPED_MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB = register("warped_mossy_bamboo_mosaic_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(BAMBOO_MOSAIC_SLAB));
    public static final Block WARPED_MOSSY_CRIMSON_VERTICAL_SLAB = register("warped_mossy_crimson_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(CRIMSON_SLAB));
    public static final Block WARPED_MOSSY_WARPED_VERTICAL_SLAB = register("warped_mossy_warped_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(WARPED_SLAB));
    public static final Block WARPED_MOSSY_STONE_VERTICAL_SLAB = register("warped_mossy_stone_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(STONE_SLAB));
    public static final Block WARPED_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB = register("warped_mossy_cobbled_deepslate_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(COBBLED_DEEPSLATE_SLAB));
    public static final Block WARPED_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB = register("warped_mossy_deepslate_brick_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(DEEPSLATE_BRICK_SLAB));
    public static final Block WARPED_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB = register("warped_mossy_deepslate_tile_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(DEEPSLATE_TILE_SLAB));
    public static final Block WARPED_MOSSY_TUFF_VERTICAL_SLAB = register("warped_mossy_tuff_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(TUFF_SLAB));
    public static final Block WARPED_MOSSY_TUFF_BRICK_VERTICAL_SLAB = register("warped_mossy_tuff_brick_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(TUFF_BRICK_SLAB));
    public static final Block WARPED_MOSSY_BRICK_VERTICAL_SLAB = register("warped_mossy_brick_vertical_slab", VerticalSlabBlock::new, BlockBehaviour.Properties.ofFullCopy(BRICK_SLAB));

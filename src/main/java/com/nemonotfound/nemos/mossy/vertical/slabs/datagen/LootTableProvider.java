...
public class LootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        this.add(ModBlocks.CRIMSON_MOSSY_OAK_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_OAK_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_SPRUCE_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_SPRUCE_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_BIRCH_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_BIRCH_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_JUNGLE_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_JUNGLE_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_ACACIA_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_ACACIA_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_DARK_OAK_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_DARK_OAK_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_MANGROVE_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_MANGROVE_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_CHERRY_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_CHERRY_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_PALE_OAK_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_PALE_OAK_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_BAMBOO_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_BAMBOO_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_CRIMSON_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_CRIMSON_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_WARPED_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_WARPED_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_STONE_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_STONE_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_BRICK_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_BRICK_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_TUFF_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_TUFF_VERTICAL_SLAB));
        this.add(ModBlocks.CRIMSON_MOSSY_TUFF_BRICK_VERTICAL_SLAB, slabDrops(ModBlocks.CRIMSON_MOSSY_TUFF_BRICK_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_OAK_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_OAK_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_SPRUCE_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_SPRUCE_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_BIRCH_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_BIRCH_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_JUNGLE_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_JUNGLE_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_ACACIA_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_ACACIA_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_DARK_OAK_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_DARK_OAK_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_MANGROVE_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_MANGROVE_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_CHERRY_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_CHERRY_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_PALE_OAK_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_PALE_OAK_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_BAMBOO_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_BAMBOO_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_CRIMSON_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_CRIMSON_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_WARPED_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_WARPED_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_STONE_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_STONE_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_BRICK_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_BRICK_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_TUFF_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_TUFF_VERTICAL_SLAB));
        this.add(ModBlocks.WARPED_MOSSY_TUFF_BRICK_VERTICAL_SLAB, slabDrops(ModBlocks.WARPED_MOSSY_TUFF_BRICK_VERTICAL_SLAB));
    }
